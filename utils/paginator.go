...
func getHeader(po *PageOptions, totalpages int) string {
	...
	if po.EnableFirstLastLink {
		...
		rs += "<li><a " + judgeDisable(po, totalpages, 0) + " href='" + po.Href + "&" + po.ParamName + "=" + con.Itoa(1) + "'>" + po.FirstPageText + "</a></li>"
	}
	if po.EnablePreNexLink {
		...
		rs += "<li><a " + judgeDisable(po, totalpages, 0) + " href='" + po.Href + "&" + po.ParamName + "=" + con.Itoa(a) + "'>" + po.PrePageText + "</a></li>"
	}
	return rs
}
